          ...
          <article className="bg-background rounded-2xl shadow-lg border border-border/50 p-8 sm:p-12">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
              <p className="lead">
                ...
                souvent une source de confusion : les polices d&apos;assurance « Occurrence » et
                « Claims-Made ». Ne vous inquiétez pas, je suis là pour vous guider pas à pas,
            ...
            <Section title="1. La Police 'Occurrence' : La couverture 'quand ça arrive'" id="occurrence">
              ...
              <p>
                ...
                où la réclamation est signalée. C&apos;est un peu comme une capsule temporelle : tant
                que l&apos;événement dommageable s&apos;est produit pendant que la police était active,
                la couverture est là, même si la réclamation est déposée des années plus tard.
              </p>
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>
                  ...
                  &quot;Occurrence&quot; de 2020 couvrirait l&apos;incident, car l&apos;événement déclencheur
                  (l&apos;occurrence) a eu lieu pendant sa période de validité.
                </li>
              </ul>
            </Section>
            ...
            <Section title='2. La Police "Claims-Made" : La couverture "quand on déclare"' id="claims-made">
              ...
              <p>
                ...
                découlent d&apos;un incident qui s&apos;est produit à partir d&apos;une date spécifique
                appelée <strong>&quot;date rétroactive&quot;</strong>.
              </p>
              <h4 className="font-bold text-primary">Exemple concret :</h4>
              <ul className="list-disc pl-5 space-y-2">
                <li>Votre client a une police &quot;Claims-Made&quot; du 1er janvier 2020 au 31 décembre 2020, avec une date rétroactive du 1er janvier 2018.</li>
                ...
                <li>
                  ...
                  déposée APRES la fin de la période de validité de la police. C&apos;est ici que la
                  &quot;Tail Coverage&quot; devient essentielle.
                </li>
              </ul>
              <h4 className="font-bold text-primary mt-6">L&apos;importance de la &quot;Tail Coverage&quot; (ou &quot;Période de Déclaration Prolongée&quot;)</h4>
              <p>
                ...
                pendant la période de la police initiale, même après son expiration. C&apos;est crucial
                lors d&apos;une retraite ou d&apos;un changement d&apos;assureur.
              </p>
            </Section>
