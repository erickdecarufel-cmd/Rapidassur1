...
const CustomPageLoader = ({ slug }: { slug: string }) => {
    const Component = React.useMemo(() => {
        ...
        const pathMap: Record<string, () => Promise<{ default: React.ComponentType<any> }>> = {
            ...
            'assurance-pros/guide-prevention-risques': () => import(`@/app/assurance-pros/guide-prevention-risques/page`),
            'assurance-pros/analyse-vision-erick-de-carufel': () => import(`@/app/assurance-pros/analyse-vision-erick-de-carufel/page`),
            'assurance-pros/difficultes-de-placement': () => import(`@/app/assurance-pros/difficultes-de-placement/page`),
            'assurance-wrap-up-expliquee': () => import(`@/app/blog/assurance-wrap-up-expliquee/page`),
            'les-extensions-meconnues-en-rcg': () => import(`@/app/blog/les-extensions-meconnues-en-rcg/page`),
            'assurance-3d-fraude-entreprise': () => import(`@/app/blog/assurance-3d-fraude-entreprise/page`),
            'guide-assurance-entrepreneur-specialise': () => import(`@/app/blog/guide-assurance-entrepreneur-specialise/page`),
            'guide-assurance-entrepreneur-general': () => import(`@/app/blog/guide-assurance-entrepreneur-general/page`),
            'reussir-son-projet-d-autoconstruction-les-assurances-cles': () => import(`@/app/blog/reussir-son-projet-d-autoconstruction-les-assurances-cles/page`),
            'autoconstruction-gcr': () => import(`@/app/blog/autoconstruction-gcr/page`),
            'guide-assurance-gestionnaire-projet': () => import(`@/app/blog/guide-assurance-gestionnaire-projet/page`),
            'assurance-sur-mesure-economies': () => import(`@/app/blog/assurance-sur-mesure-economies/page`),
            'risques-hasardeux-construction': () => import(`@/app/blog/risques-hasardeux-construction/page`),
            'engagements-formels-assurance-construction': () => import(`@/app/blog/engagements-formels-assurance-construction/page`),
            'ecosysteme-assurance-nouvelle-generation': () => import(`@/app/blog/ecosysteme-assurance-nouvelle-generation/page`),
            'phenomene-assurance-dommages-quebec': () => import(`@/app/blog/phenomene-assurance-dommages-quebec/page`),
            'coup-de-maitre-assurance-quebec': () => import(`@/app/blog/coup-de-maitre-assurance-quebec/page`),
            ...
            'assurance-cyber-risques': () => import(`@/app/assurance-cyber-risques/page`),
            'metier': () => import(`@/app/blog/metier/[metierId]/page`), // For profession-specific blogs
            'sinistre': () => import(`@/app/sinistre/page`),
            'occurrence-vs-claims-made': () => import(`@/app/blog/occurrence-vs-claims-made/page`),
            'risques-poussiere-industrie-bois': () => import('@/app/blog/risques-poussiere-industrie-bois/page'),
            'assurance-entreprise-les-fondamentaux': () => import('@/app/blog/assurance-entreprise-les-fondamentaux/page'),
            'assurance-biens-confies-soin-garde-controle': () => import('@/app/blog/assurance-biens-confies-soin-garde-controle/page'),
        };
        ...
        if (!loadComponent) {
            const PageEnConstruction = () => <div>Page en construction.</div>;
            PageEnConstruction.displayName = 'PageEnConstruction';
...
CustomPageLoader.displayName = 'CustomPageLoader';
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-grow container mx-auto px-4 py-12 text-center">
                ...
                <p className="text-muted-foreground mb-8">Désolé, l&apos;article que vous cherchez n&apos;existe pas ou a été déplacé.</p>
                <Button asChild>
                    <Link href="/blog">
