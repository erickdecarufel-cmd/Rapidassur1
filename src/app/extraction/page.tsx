            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-10 text-center">
                    ...
                    <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                        Copiez les données brutes (RBQ, REQ, GCR) et laissez l'IA structurer la fiche client parfaite. Approche &quot;Small Bites&quot; incrémentale.
                    </p>
                </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="bg-white p-6 rounded-xl border border-blue-100 shadow-sm hover:shadow-md transition-all group">
                                ...
                                <button onClick={handleRBQPaste} disabled={isAnalyzing} className="w-full py-3 px-4 bg-slate-50 hover:bg-blue-50 text-slate-700 hover:text-ra-blue font-medium rounded-lg border border-dashed border-slate-300 hover:border-ra-blue transition-all flex items-center justify-center gap-2">
                                    {isAnalyzing ? (
