...
export default function PropositionsNouvellesAffaires() {
  ...
  const callBrokerAlert = form?.callBrokerTags.length
    ? form.callBrokerTags.some(tag =>
          ...
          {form && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
              <div className="flex flex-wrap items-center gap-3">
                ...
                {selectedAssureur && (
                  <span className="text-xs bg-[#003366] text-white rounded px-2 py-0.5 font-medium">
                    {selectedAssureur}
                  </span>
                )}
              </div>
                ...
                <div className="w-24 h-1.5 bg-gray-200 rounded-full overflow-hidden">
                  <div
                    className={`h-full rounded-full transition-all duration-300 ${
                      fichePct === 100 ? 'bg-green-500' :
                      fichePct >= 50  ? 'bg-[#E9711C]' : 'bg-gray-300'
                    }`}
                    style={{ width: `${fichePct}%` }}
                  />
                </div>
                <span className="text-xs text-gray-500 w-16 text-right">
                  {ficheRemplis}/{ficheTotal} champs
                </span>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    type="text"
                    className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#2563EB] bg-gray-50 focus:bg-white"
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="jean@constructionabc.com"
                    type="email"
                    className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#2563EB] bg-gray-50 focus:bg-white"
                  />
                </div>
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                <div className="flex items-center justify-between px-3 py-2 bg-gray-50 border-b border-gray-200">
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      onClick={copyUrl}
                      className="flex items-center gap-1 text-xs text-[#2563EB] hover:text-blue-800 font-medium"
                    >
