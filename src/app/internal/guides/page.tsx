        ...
        <div className="max-w-4xl mx-auto">
            <header className="space-y-4 mb-8">
                ...
                <div className="text-center">
                    ...
                    <p className="text-lg text-muted-foreground mt-2">Préparez votre dossier efficacement. Ces guides vous expliquent pourquoi chaque information est nécessaire pour obtenir la meilleure protection.</p>
                </div>
            </header>
